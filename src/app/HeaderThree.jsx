    ...
    return (
        <header className="w-[95%] flex mx-auto bg-white font-[Roboto] rounded-2xl p-2">
            <div className="flex flex-col w-full">
                <div className="w-full px-5 py-2 bg-gray-100 rounded-2xl flex justify-between items-center text-white">

                    <div className="flex items-center text-black text-lg gap-14">
                    ...
                    <div className="flex items-center gap-5">
                        <div className="bg-white text-black w-12 h-12 rounded-full flex justify-center items-center cursor-pointer">
                            <FaSearch size={18} />
                        </div>
                        ...
                        <button className="bg-[#2B7EC2] text-white font-bold px-8 py-3 rounded-lg text-[18px] shadow-md hover:bg-[#05d1ff]">
                            Product Profile
                        </button>
