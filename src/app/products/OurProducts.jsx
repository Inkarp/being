...
function ProfileCard({ profile, isOpen, index, setOpenIndex }) {
  ...
  return (
    <div className="w-full h-full group rounded-3xl overflow-hidden hover:border border-[#2B7EC2]  hover:shadow-md relative hover:scale-[1.05] transition-transform duration-200">
      <Link href={profile.link} className="block">
        <div className="bg-[#2F4191]/20 p-5 h-[160px] flex flex-col justify-center">
          <div className="flex items-center mb-3">
            <div className="w-14 h-14 rounded-full grid place-items-center border border-[#2B7EC2] bg-white p-2">
              <Image
                src={profile.icon}
