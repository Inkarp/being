                ...
                {profiles.map((profile, index) => (
                    ...
                    >
                       ...
                       <div className="absolute -top-4 -right-4 w-20 h-20 bg-gradient-to-br from-white to-gray-100/80 backdrop-blur-sm border-3 border-black/50 rounded-2xl flex items-center justify-center shadow-2xl rotate-15 group-hover:rotate-0 group-hover:scale-110 transition-all duration-700">
                        ...
                        {/* Icon Orb */}
                        <div className={`w-28 h-28 rounded-3xl bg-white/60 flex items-center justify-center shrink-0 shadow-xl group-hover:shadow-2xl group-hover:scale-110 transition-all duration-500 ring-2 ring-[#2F4191]/50 group-hover:ring-[#2B7EC2]/50`}>
                            <Image
                                src={profile.icon}
                                alt={profile.name}
                                width={64}
                        ...
                        {/* Arrow Indicator */}
                        <div className="absolute bottom-4 right-4 w-6 h-6 border-r-2 border-b-2 border-[#2B7EC2]/60 group-hover:border-white rotate-45 group-hover:translate-x-1 transition-all duration-300 opacity-0 group-hover:opacity-100" />
                    </Link>
                ))}
            </div>
        </section>
