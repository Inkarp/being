        ...
        <section className="w-full py-5 relative overflow-hidden">
            ...
            <div className="text-center max-w-3xl mx-auto relative z-10">
                <h2 className="text-4xl md:text-5xl py-2 font-bold bg-gradient-to-r from-gray-900 to-slate-800 bg-clip-text text-transparent drop-shadow-lg">
                    Everything you need <span className="text-[#2F4191] drop-shadow-md">in one place</span>
                </h2>
                ...
                {profiles.map((profile, index) => (
                    <Link
                        ...
                        <div className="absolute -bottom-4 -right-4 w-20 h-15 bg-white backdrop-blur-sm border-2 border-white rounded-2xl flex items-center justify-center shadow-2xl rotate-0 group-hover:scale-110 transition-all duration-700">
                            ...
                            <FaArrowRight
                                size={16}
                                className="absolute right-10 bottom-5 text-black animate-bounce"
                            />
                        </div>
                        <div className="w-[30px] h-[30px] text-white absolute top-4 left-4">
                            <svg
                                width="30"
                                height="30"
                                viewBox="0 0 30 30"
                            ...
                            {/* <FaArrowRight
                                size={12}
                                className="absolute top-1/2 left-1/2 text-black  "
                            /> */}

                            <span className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-sm font-medium text-gray-800 uppercase tracking-wider drop-shadow-md">{index + 1}</span>
                        </div>

                        {/* Icon Orb */}
                        <div className={` rounded-3xl flex items-center justify-center shrink-0 group-hover:ring-[#2B7EC2]/50`}>
                            <Image
                                src={profile.icon}
                                alt={profile.name}
                                width={200}
