    ...
    <section className="py-5">
      ...
      <div className="w-full mx-auto grid grid-cols-1 lg:grid-cols-3 gap-5 py-6 items-stretch">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 flex-1">
            {events.map((blog, index) => (
              ...
              >
                ...
                {/* Content */}
                <div className="relative group flex flex-col flex-1 p-4 items-center text-center gap-4">
                  <h3 className="font-bold text-base text-black leading-snug line-clamp-3">
                    {blog.title}
                  </h3>
                  <div className="absolute inset-0 flex items-end justify-center bg-gradient-to-t from-[#2F4191]/80 via-[#2B7EC2]/40 to-transparent translate-y-full group-hover:translate-y-0 transition-transform duration-500 ease-out">
                    <button

                      className="mb-6 inline-flex items-center gap-3 bg-white text-[#2F4191] font-semibold px-4 py-2 rounded-full shadow-xl hover:scale-105 transition-all duration-300"
                    >
        ...
        <aside className="lg:col-span-1 h-full flex flex-col">
          ...
          <div className="grid grid-cols-1 md:grid-cols-1 gap-8 flex-1">
            {blogs.map((blog, index) => (
              <div
                key={index}
                className="bg-[#2F4191] rounded-2xl overflow-hidden shadow hover:shadow-md transition-all duration-300 flex flex-col h-full"
              >
                {/* Image */}
                ...
                <div className="flex flex-col flex-1 p-4 items-center text-center gap-4">
                  <h3 className="font-bold text-base text-white leading-snug line-clamp-3">
                    {blog.title}
                  </h3>
