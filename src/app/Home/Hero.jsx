    ...
    return (
        <section className="w-full mx-auto rounded-[30px] h-[80vh] flex overflow-hidden">
            ...
            <div className="w-2/5 h-full relative bg-white">
                ...
                {/* <button className='absolute bottom-10 left-1/2 transform -translate-x-1/2 bg-white text-black px-6 py-2 rounded-full font-semibold hover:bg-gray-200 transition-colors'>
                    {names[currentSlide]}
                </button> */}
            </div>
        </section>
