      ...
      <div className="w-full mx-auto  text-center">
        ...
        <div className="relative grid grid-cols-1 md:grid-cols-5 gap-8 transition-all duration-500 rounded-2xl py-3">
          ...
          {causes.map((cause, index) => (
            <div
              key={index}
              className="group relative border border-gray-100 shadow-xl overflow-hidden rounded-[30px] hover:border-[#2B7EC2] hover:scale-[1.05] transition-all duration-500">
              ...
              <div className="relative p-5 flex flex-col justify-center items-center text-center space-y-3">
