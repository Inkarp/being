...
export default function Header() {
  ...
  return (
    <>
      <div className={`fixed top-0 left-1/2 -translate-x-1/2 z-50 w-[100%] lg:w-[100%] flex items-center justify-between lg:px-0 sm:px-0 lg:py-0 sm:py-0 px-0 border-b-2 border-[#2F4191]/30 shadow-2xl backdrop-blur-lg bg-white/80 font-raleway transition-transform duration-300 ${isVisible && !isSidebarOpen ? 'translate-y-0' : '-translate-y-full'}`}>
