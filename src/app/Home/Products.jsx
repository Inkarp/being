    ...
    return (
        <section className="py-5">
            <div className="w-full mx-auto text-center px-4">
                ...
                <p className="text-3xl md:text-4xl font-semibold text-gray-900 mb-3 max-w-4xl mx-auto leading-tight">
                    Our <span className="text-[#2F4191] font-black">Customers</span> love our products
                </p>

                {/* Image Grid - 4 columns */}
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 ">
                    {causes.map((cause, index) => (
                        <div key={index} className="group relative overflow-hidden rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500  hover:-translate-y-4 h-70 w-70 bg-gray-100 ">
                            {/* Product Image */}
                            <div className="relative w-full h-full p-5">
                                ...
                                />
                                <div className='absolute bottom-3 right-20 bg-[#2F4191] rounded-xl px-3 py-2 ring-2 ring-black'>
                                    <h3 className="text-xl text-white drop-shadow-lg leading-tight">
                                        {cause.title}
                                    </h3>
                                </div>
                            </div>
                            ...
                            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black to-black/60 backdrop-blur-sm translate-y-full group-hover:translate-y-0 transition-all duration-800 ease-out p-6 rounded-b-3xl transition duration-300">
                                <h3 className="text-xl font-bold text-white mb-3 drop-shadow-lg leading-tight">
                                    {cause.title}
                                </h3>

                                <Link
                                    href={cause.link}
                                    className="inline-flex items-center gap-3 bg-white/90 backdrop-blur-sm hover:bg-white text-[#2F4191] font-bold px-6 py-3 rounded-2xl shadow-2xl hover:shadow-xl hover:scale-105 transition-all duration-300 group/link"
                                >
