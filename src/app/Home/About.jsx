        ...
        <div className="space-y-5 lg:order-2">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-12">
            ...
            <div className="group flex items-start gap-4 p-8 rounded-2xl border border-gray-100 hover:shadow-2xl hover:border-gray-200 transition-all duration-400 bg-gray-50/50">
              ...
              <div className="min-w-0 flex-1">
                <Link href="/about-us" >
                  <div className="flex items-center justify-center gap-3  px-3 py-2 rounded-full w-max cursor-pointer transition-colors">
                    <h4 className="font-bold text-xl text-gray-900 mb-3 group-hover:text-gray-950">Know Us</h4>
                    {/* Gear SVG with arrow inside */}
                    <div className="relative w-[60px] h-[60px] text-[#2F4191]">
                      <svg
                        width="60"
                        height="60"
                        viewBox="0 0 30 30"
