    ...
    <section className="py-20 px-4 text-black">
      ...
      <div>
        ...
        <div className="text-blue-700 font-semibold mb-2 flex items-center gap-2">
          ...
          <img src={'/molecule.svg'} className='h-5 w-5 animate-spin' />
          <div className="flex">
            <span className="inline-block animate-bounce text-3xl" style={{ animationDelay: '0s' }}>A</span>
            <span className="inline-block animate-bounce text-3xl" style={{ animationDelay: '0.1s' }}>B</span>
            <span className="inline-block animate-bounce text-3xl" style={{ animationDelay: '0.2s' }}>O</span>
            <span className="inline-block animate-bounce text-3xl" style={{ animationDelay: '0.3s' }}>U</span>
            <span className="inline-block animate-bounce text-3xl" style={{ animationDelay: '0.4s' }}>T</span>

            {/* Gap after "ABOUT" */}
            <span className="inline-block w-4"></span> {/* adds fixed space */}

            <span className="inline-block animate-bounce text-3xl" style={{ animationDelay: '0.6s' }}>U</span>
            <span className="inline-block animate-bounce text-3xl" style={{ animationDelay: '0.7s' }}>S</span>
          </div>
        ...
        <div className="flex flex-wrap gap-4 items-center justify-around">
          ...
          {/* <div className="flex items-center gap-3 bg-[#2F3F8D] px-6 py-3 rounded-full w-fit">
              ...
              <div className="relative w-[30px] h-[30px] text-white">
                ...
                <FaArrowRight
                  size={12}
                  className="absolute top-1/2 left-1/2 text-black transform -translate-x-1/2 -translate-y-1/2 bounce-right "
                />
              </div>
            </div> */}
