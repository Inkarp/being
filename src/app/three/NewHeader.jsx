        ...
        >
            ...
            <div
                className={`${isScrolled
                        ? "flex items-center justify-center px-6 absolute left-3/8 top-5 rounded-full bg-gray-200 border-x-4 border-[#2F4191]"
                        : "w-[15%] flex items-center justify-between px-6 rounded-full bg-gray-200 border-x-4 border-[#2F4191]"
                    }`}
            >
            ...
            {/* Navigation + Search */}
            <div
                className={`${isScrolled ? "hidden" : "w-[85%] flex justify-between bg-[#2B7EC2] rounded-full py-3 px-3 border-x-4 border-[#2F4191]"
                    }`}
            >
                <nav className="flex items-center gap-8 text-white font-semibold text-[18px] px-5">
                    ...
                    <span className="cursor-pointer hover:text-cyan-300">Products</span>
