...
export default function NewFooter() {
    return (
        <footer className="bg-gray-200 text-black pt-5 w-[95%] mx-auto rounded-t-[50px]">
            {/* Top Grid Section */}
            ...
            <div className="py-5 px-15">
                <div className="max-w-7xl bg-[#2B7EC2] mx-auto py-3 px-5 flex flex-col lg:flex-row justify-between items-center gap-6 text-black font-bold text-sm md:text-base rounded-xl">
