...
export async function POST(request) {
  try {
    ...
    const mailOptions = {
      ...
      subject: `Exclusive Partnership Details | ${formData.product}`,
      html: `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8"/>
  <meta name="viewport" content="width=device-width,initial-scale=1.0"/>
  <title>Exclusive Partnership — ${formData.product}</title>
</head>
    ...
    <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;border:1px solid #e5e7eb;">
      <tr>
        <td style="padding:20px 15px;background:#2F4191;color:white;">
          <h2 style="margin:0 0 10px;font-size:18px;color:white;">Exclusive Partnership</h2>
      ...
      <tr>
        <td style="padding:0;">
          <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
            ${sectionHead('Partnership Details')}
